...
func registerIDTInterrupts() {
    logger.log(staticString: "IDT: registering interrupts...")

    registerInterrupt(index: 0, handle_exception_division_error)
    logger.log(staticString: "IDT: registered interrupt: division error")

    registerInterrupt(index: 1, handle_exception_debug)
    logger.log(staticString: "IDT: registered interrupt: debug")

    registerInterrupt(index: 2, handle_exception_nonmaskable_interrupt)
    logger.log(staticString: "IDT: registered interrupt: non-maskable interrupt")

    registerInterrupt(index: 3, handle_exception_breakpoint)
    logger.log(staticString: "IDT: registered interrupt: breakpoint")

    registerInterrupt(index: 4, handle_exception_overflow)
    logger.log(staticString: "IDT: registered interrupt: overflow")

    registerInterrupt(index: 5, handle_exception_bound_range_exceeded)
    logger.log(staticString: "IDT: registered interrupt: bound range exceeded")

    registerInterrupt(index: 6, handle_exception_invalid_opcode)
    logger.log(staticString: "IDT: registered interrupt: invalid opcode")

    registerInterrupt(index: 7, handle_exception_device_not_available)
    logger.log(staticString: "IDT: registered interrupt: device not available")

    registerInterrupt(index: 8, handle_exception_double_fault)
    logger.log(staticString: "IDT: registered interrupt: double fault")

    registerInterrupt(index: 10, handle_exception_invalid_tss)
    logger.log(staticString: "IDT: registered interrupt: invalid tss")

    registerInterrupt(index: 11, handle_exception_segment_not_present)
    logger.log(staticString: "IDT: registered interrupt: segment not present")

    registerInterrupt(index: 12, handle_exception_stack_segment_fault)
    logger.log(staticString: "IDT: registered interrupt: stack-segment fault")

    registerInterrupt(index: 13, handle_exception_general_protection_fault)
    logger.log(staticString: "IDT: registered interrupt: general protection fault")
    
    registerInterrupt(index: 14, handle_exception_page_fault)
    logger.log(staticString: "IDT: registered interrupt: page fault")

    registerInterrupt(index: 15, handle_exception_15)
    logger.log(staticString: "IDT: registered interrupt: 15")

    registerInterrupt(index: 16, handle_exception_x87_floating_point_exception)
    logger.log(staticString: "IDT: registered interrupt: x87 floating-point exception")

    registerInterrupt(index: 17, handle_exception_alignment_check)
    logger.log(staticString: "IDT: registered interrupt: alignment check")

    registerInterrupt(index: 18, handle_exception_machine_check)
    logger.log(staticString: "IDT: registered interrupt: machine check")

    registerInterrupt(index: 19, handle_exception_simd_floating_point_exception)
    logger.log(staticString: "IDT: registered interrupt: SIMD floating-point exception")

    registerInterrupt(index: 20, handle_exception_virtualization_exception)
    logger.log(staticString: "IDT: registered interrupt: virtualization exception")

    registerInterrupt(index: 21, handle_exception_control_protection_exception)
    logger.log(staticString: "IDT: registered interrupt: control protection exception")

    registerInterrupt(index: 22, handle_exception_22)
    logger.log(staticString: "IDT: registered interrupt: 22")

    registerInterrupt(index: 23, handle_exception_23)
    logger.log(staticString: "IDT: registered interrupt: 23")

    registerInterrupt(index: 24, handle_exception_24)
    logger.log(staticString: "IDT: registered interrupt: 24")

    registerInterrupt(index: 25, handle_exception_25)
    logger.log(staticString: "IDT: registered interrupt: 25")

    registerInterrupt(index: 26, handle_exception_26)
    logger.log(staticString: "IDT: registered interrupt: 26")

    registerInterrupt(index: 27, handle_exception_27)
    logger.log(staticString: "IDT: registered interrupt: 27")

    registerInterrupt(index: 28, handle_exception_hypervisor_injection_exception)
    logger.log(staticString: "IDT: registered interrupt: hypervisor injection exception")

    registerInterrupt(index: 29, handle_exception_vmm_communication_exception)
    logger.log(staticString: "IDT: registered interrupt: VMM communication exception")

    registerInterrupt(index: 30, handle_exception_security_exception)
    logger.log(staticString: "IDT: registered interrupt: security exception")

    registerInterrupt(index: 31, handle_exception_31)
    logger.log(staticString: "IDT: registered interrupt: 31")

    registerInterrupt(index: 33, keyboard_handler)
    logger.log(staticString: "IDT: registered interrupt: 33")

    logger.log(staticString: "IDT: registered interrupts")
}
...
func handleExceptionDivisionError() {
    ...
    logger.log(staticString: "PANIC: division error at address \\(fa)")
...
func handleExceptionDebug() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: debug at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionNonmaskableInterrupt() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: non-maskable interrupt at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionBreakpoint() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: breakpoint at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionOverflow() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: overflow at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionBoundRangeExceeded() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: bound range exceeded at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionInvalidOpcode() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: invalid opcode at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionDeviceNotAvailable() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: device not available at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionDoubleFault() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: double fault at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionInvalidTSS() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: invalid tss at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionSegmentNotPresent() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: segment not present at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionStackSegmentFault() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: stack segment fault at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionGeneralProtectionFault() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: general protection fault at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionPageFault() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: page fault at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleException15() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: exception 15 at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionX87FloatingPointException() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: x87 floating-point exception at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionAlignmentCheck() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: alignment check at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionMachineCheck() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: machine check at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionSIMDFloatingPointException() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: simd floating-point exception at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionVirtualizationException() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: virtualization exception at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionControlProtectionException() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: control protection exception at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleException22() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: exception 22 at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleException23() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: exception 23 at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleException24() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: exception 24 at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleException25() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: exception 25 at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleException26() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: exception 26 at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleException27() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: exception 27 at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionHypervisorInjectionException() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: hypervisor injection exception at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionVMMCommunicationException() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: vmm communication exception at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleExceptionSecurityException() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: security exception at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}
...
func handleException31() {
    //let fa = readFaultAddress()
    logger.log(staticString: "PANIC: exception 31 at address \\(fa)")
    LocalAPIC.endOfInterrupt()
    cpu_halt()
}